...
print(
    ...
    html(['lang' => 'en'],
      head(['data-pw-id' => 'html-head'],
        ...
        // Styles
        link(['href'=>$urls->templates.'css/tachyons/css/tachyons.min.css', 'rel' => 'stylesheet']).
        link(['href'=>$urls->templates.'css/main.css', 'rel' => 'stylesheet']).
      ...
      body(['class' => 'bg-black helvetica white', 'data-pw-id' => 'html-body'],
        ...
        // Scripts
        script(['src' => $urls->templates.'js/blazy/blazy.min.js']).
        script(['src' => $urls->templates.'js/main.js']).
